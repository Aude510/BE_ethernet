...
HD_PWD='/home/rmoulin/4A/BE-Acces/Ethernet_Controller/Ethernet_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ethernet_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ethernet_controller.tcl
