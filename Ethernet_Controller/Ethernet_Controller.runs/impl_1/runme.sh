...
HD_PWD='/home/rmoulin/4A/BE-Acces/Ethernet_Controller/Ethernet_Controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ethernet_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ethernet_controller.tcl -notrace
