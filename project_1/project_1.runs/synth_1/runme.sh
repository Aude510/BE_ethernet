...
HD_PWD='/home/rmoulin/4A/BE-Acces/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bits8_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bits8_counter.tcl
