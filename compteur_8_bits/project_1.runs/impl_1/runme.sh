...
HD_PWD='/home/rmoulin/4A/BE-Acces/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bits8_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bits8_counter.tcl -notrace
